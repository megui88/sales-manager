                                        ...
                                        <div class="panel-body">
                                            <table class="table table-bordered">
                                                ...
                                                @foreach($items['accredits'] as $accredit)
                                                    <tr style="text-align: right">
                                                        <td style="text-align: center"> A {{ $accredit->sale->concept->name }}</td>
                                                ...
                                                <tbody>
                                                @foreach($items['incomes'] as $income)
                                                    <tr style="text-align: right">
                                                        <td style="text-align: center">Gastos Administrativos</td>
                                                        <td><a href="/sales/{{ $income->sale->id }}" class="btn btn-link">{{ $income->sale->id }}</a></td>
                                                        <td style="text-align: center">{{ $income->sale->description }}</td>
                                                        <td>{{ $income->number_of_quota }} / {{ $income->sale->installments }}</td>
                                                        <td>{{ \App\Helpers\BladeHelpers::import($income->amount_of_quota) }}</td>
                                                    </tr>
                                                    <?php $total += $income->amount_of_quota; ?>
                                                @endforeach
                                                </tbody>
