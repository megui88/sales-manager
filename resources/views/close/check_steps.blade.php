        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="panel panel-default">
                    ...
                    <form class="form" action="/close/check_purchase_orders" method="post">
                        <div class="panel-body">
                            <h1> Las siguientes Ordenes de Compras seran Anuladas por falta de confirmación en dos periodos</h1>
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="panel panel-default">
